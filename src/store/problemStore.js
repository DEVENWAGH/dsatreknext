...
export const useProblemStore = create(() => ({
  ...
  // Migration notice
  _migrationNotice: 'This store is deprecated. Use TanStack Query hooks instead.',
  
  // Stub methods for backward compatibility
  getAllProblems: () => {
    console.warn('useProblemStore.getAllProblems is deprecated. Use useProblems() hook instead.');
    return Promise.resolve({ data: { data: [] } });
  },
  
  getProblem: () => {
    console.warn('useProblemStore.getProblem is deprecated. Use useProblem(id) hook instead.');
    return Promise.resolve({ data: { data: null } });
  },
  
  getProblemFromCache: () => {
    console.warn('useProblemStore.getProblemFromCache is deprecated. Use useProblem(id) hook instead.');
    return null;
  },
